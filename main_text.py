    ...
    for epoch in range(num_epochs):
        ...
        print(
            'val loss: {:.4f}, acc: {:.4f}, f1: {:.4f}, precision: {:.4f}, recall: {:.4f}'.format(epoch_loss, epoch_acc,
                                                                                                  ...
                                                                                                  epoch_recall))
        print(
            'best loss: {:.4f}, acc: {:.4f}, f1: {:.4f}, precision: {:.4f}, recall: {:.4f}, epoch {}'.format(best_loss,
                                                                                                             best_acc,
                                                                                                             best_f1,
                                                                                                             best_precision,
                                                                                                             best_recall,
...
def train_model_multi_label_classification(model, train_dataloaders, val_dataloaders, criterion, optimizer,
                                           num_epochs=5):
    best_acc = 0.0
    best_loss = 0.0
    best_f1 = 0.0
...
if __name__ == '__main__':
    ...
    for fold, (train_idx, val_idx) in enumerate(kfold.split(df)):
        ...
        if args.exp_mode == 1:
            fold_f1, fold_precision, fold_recall, fold_acc = train_model_multi_classification(model, train_dataloaders,
                                                                                              val_dataloaders,
                                                                                              criterion, optimizer,
                                                                                              args.num_epochs)
        elif args.exp_mode == 3:
            fold_f1, fold_precision, fold_recall, fold_acc = train_model_multi_label_classification(model,
                                                                                                    train_dataloaders,
                                                                                                    val_dataloaders,
                                                                                                    criterion,
                                                                                                    optimizer,
            ...
            fold_f1, fold_precision, fold_recall, fold_acc = train_model_binary_classification(model, train_dataloaders,
                                                                                               val_dataloaders,
                                                                                               criterion, optimizer,
                                                                                               args.num_epochs)
